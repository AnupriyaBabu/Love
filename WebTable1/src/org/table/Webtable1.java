...
public class Webtable1 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\venki\\eclipse-workspace\\WebTable1\\Driver\\chromedriver.exe");
		
		WebDriver driver=new ChromeDriver();
		
		driver.get("https://www.business-standard.com/sports/pro-kabaddi-league/points-table");
